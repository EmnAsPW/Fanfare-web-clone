      ...
      <div className="lg:w-full w-[55px] mx-auto">
        ...
        <div className="lg:block hidden text-[11px] text-gray-500">
          <div className="pt-4 px-2">
            About Newsroom Fanfare Shop Contact Careers ByteDance
          </div>
          <div className="pt-4 px-2">
            Fanfare for Good Advertise Developers Transperancy Fanfare Rewards
            Fanfare Browse Fanfare
          </div>
          <div className="pt-4 px-2">2023 Fanfare</div>
